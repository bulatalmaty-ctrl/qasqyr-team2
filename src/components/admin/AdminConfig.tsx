...
export default function AdminConfig() {
  ...
  return (
    <div className="bg-surface-container p-6 rounded-lg space-y-4 text-on-surface">
      ...
      <button onClick={handleSave} disabled={saving} className="bg-primary text-on-primary px-4 py-2 mt-4 font-bold disabled:opacity-50 cursor-pointer border border-transparent hover:border-white transition-colors">
